...
export default function Compare() {
  ...
  // ✅ FIX 1: ref declared once here (was duplicated / misplaced before)
  ...
  const downloadReport = async () => {
    ...
    pdf.text("PolicyIQ — Policy Comparison Report", 10, 13);
    ...
    // Save
    const filename = `PolicyIQ_Comparison_${result.policy_1.id}_vs_${result.policy_2.id}.pdf`;
    pdf.save(filename);
  };
  ...
  return (
    <div style={{ padding: "28px 32px" }}>
      ...
      {/* ✅ FIX 2: reportRef wraps the ENTIRE result panel so html2canvas captures everything */}
      {step === 3 && result && !loading && (
        <div className="fade-up" style={{ marginBottom: 24 }}>

          {/* ✅ This div is what gets captured as the PDF snapshot */}
          <div ref={reportRef}>
          ...
          </div>{/* ← end of reportRef div (only content above is captured in PDF) */}

          {/* ✅ FIX 3: Download button is OUTSIDE reportRef so it doesn't appear in the PDF */}
